...
d <- data.frame(name=c("seu nome"), sobrenome=c("seu sobrenome"), aniversario=c("seu aniversario"))
...
Agora crie um novo diretório chamado `processados` e grave/salve a tabela que você limpou.
